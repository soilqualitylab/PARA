---
title: Training Practice and Dojo 5S
type: project
tags: goals, requirements, deadlines
alias: ideation, planned, in-process, completed, reviewed
---

# Training Practice and Dojo 5S

This sprint applies the '5S' 'Kaizen' 56 principles 55 to the martial arts training practice and the more training-focused areas of the 'Dojo' 37 itself, since it is also likely that these more nearly public areas will be more likely to see visits from others, as opposed to the more private areas of the home like the library or bedrooms. There are specific things like enzymatic disinfection of mats and adjacent bathroom areas to ensure hygiene for visitors ... but since grappling can be hands-on, personal hygiene and things like bathing are also important. This links the 'Kaizen-DevOps' (15%) epic to the 'Dojo' 37 epic. The 'Dojo's "cleanliness at the core" 37 will be the model for the '5S' 56 "Standardize" 50 principle for the entire 'Symbiotic Home'.10 This "programs" the mindset: the 'Dojo' 37 is the '5S' 56 "practice".56
